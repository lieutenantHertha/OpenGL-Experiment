...
namespace Test{
	...
	private:
		...
		glm::mat4 m_ViewMatrix = glm::lookAt(glm::vec3(0.000f, 0.000f, 10.000f),
			                                 glm::vec3(0.000f, 0.000f, 0.000f),
			                                 glm::vec3(0.000f, 1.000f, 0.000f));
		glm::mat4 m_ModelMatrix = glm::mat4(1.000f);
		float radius = 10.000f;
		glm::vec3 m_CameraDirection  = glm::vec3(0.000f, 0.000f, 0.000f);
	public:
		TestTexture3D();
		~TestTexture3D();
